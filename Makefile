...
utunes.out: ${BUILD_DIR}/exceptions.o ${BUILD_DIR}/main.o ${BUILD_DIR}/song.o ${BUILD_DIR}/utunes.o ${BUILD_DIR}/user.o
	${CC} ${BUILD_DIR}/exceptions.o ${BUILD_DIR}/utunes.o ${BUILD_DIR}/main.o ${BUILD_DIR}/user.o ${BUILD_DIR}/song.o ${CC_FLAGS} -o utunes.out

${BUILD_DIR}/utunes.o: utunes.cpp exceptions.h song.h user.h
